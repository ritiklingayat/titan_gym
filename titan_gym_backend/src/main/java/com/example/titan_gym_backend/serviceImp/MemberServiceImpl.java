...
public class MemberServiceImpl implements MemberService {
    ...
    private MemberResponse convertToResponse(Member member){
        ...
        double totalFee =
                getPlanPrice(member.getPlanId());



        double balance =
                totalFee - member.getPaidAmount();
        ...
        LocalDate expiryDate =
                member.getJoinDate()
                        .plusMonths(
                                getPlanMonths(member.getPlanId())
                        );
        ...
        return MemberResponse.builder()
                ...
                .planName(getPlanName(member.getPlanId()))
    ...
    private String getPlanName(String planId){
        ...
        return switch(planId){
            ...
            case "quarterly" -> "3 Month Plan";

            case "halfyearly" -> "6 Month Plan";

            case "pt_monthly" -> "One Month General P.T.";

            case "pt_yearly" -> "One Month P.T.";
